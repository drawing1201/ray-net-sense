...
void RayletClient::NetPing(const rpc::NetPingRequest &request,
                           const rpc::ClientCallback<rpc::NetPingReply> &callback,
                           int64_t timeout_ms) {
  INVOKE_RPC_CALL(NodeManagerService,
                  NetPing,
                  request,
...
void RayletClient::NetBandwidthProbe(
    const rpc::NetBandwidthProbeRequest &request,
    const rpc::ClientCallback<rpc::NetBandwidthProbeReply> &callback,
    int64_t timeout_ms) {
  INVOKE_RPC_CALL(NodeManagerService,
                  NetBandwidthProbe,
                  request,
