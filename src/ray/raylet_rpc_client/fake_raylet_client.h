...
class FakeRayletClient : public RayletClientInterface {
 public:
  ...
  void NetPing(const NetPingRequest &request,
               const ClientCallback<NetPingReply> &callback,
  ...
  void NetBandwidthProbe(const NetBandwidthProbeRequest &request,
                         const ClientCallback<NetBandwidthProbeReply> &callback,
                         int64_t timeout_ms) override {
    NetBandwidthProbeReply reply;
    reply.set_seq(request.seq());
