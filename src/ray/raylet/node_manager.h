...
class NodeManager : public rpc::NodeManagerServiceHandler,
 ...
 public:
  ...
  void HandleNetPing(rpc::NetPingRequest request,
                     rpc::NetPingReply *reply,
                     rpc::SendReplyCallback send_reply_callback) override;

  void HandleNetBandwidthProbe(rpc::NetBandwidthProbeRequest request,
 ...
 private:
  ...
  uint32_t network_sense_seq_ = 0;
  absl::flat_hash_map<NodeID, int> network_sense_in_flight_per_node_;
  absl::flat_hash_map<NodeID, std::deque<double>> network_sense_rtt_samples_ms_;
  absl::flat_hash_map<NodeID, double> network_sense_rtt_ms_ewma_;
  absl::flat_hash_map<NodeID, double> network_sense_rtt_ms_p50_;
  absl::flat_hash_map<NodeID, double> network_sense_jitter_ms_;
  absl::flat_hash_map<NodeID, int> network_sense_bw_in_flight_per_node_;
  absl::flat_hash_map<NodeID, std::deque<double>> network_sense_bw_samples_mbps_;
  absl::flat_hash_map<NodeID, double> network_sense_bw_mbps_ewma_;
  absl::flat_hash_map<NodeID, double> network_sense_bw_mbps_p50_;
  absl::flat_hash_map<NodeID, uint64_t> network_sense_last_update_ms_;
