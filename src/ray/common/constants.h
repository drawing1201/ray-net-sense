...
constexpr char kNetworkSensingNamespace[] = "network_sense";
constexpr char kNetworkSensingNodeReportKeyPrefix[] = "edge_samples:";
constexpr char kNetworkSensingTopologySnapshotKey[] = "topology_snapshot";
