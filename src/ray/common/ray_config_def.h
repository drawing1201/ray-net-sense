...
RAY_CONFIG(bool, network_sense_enabled, false)
RAY_CONFIG(uint64_t, network_sense_tick_ms, 2000)
RAY_CONFIG(uint32_t, network_sense_rtt_m, 5)
RAY_CONFIG(double, network_sense_rtt_alpha, 0.3)
RAY_CONFIG(uint64_t, network_sense_rtt_ttl_ms, 6000)
RAY_CONFIG(uint32_t, network_sense_rtt_concurrency_per_node, 2)
RAY_CONFIG(bool, network_sense_bw_enabled, false)
RAY_CONFIG(uint64_t, network_sense_bw_payload_bytes, 1048576)
RAY_CONFIG(uint32_t, network_sense_bw_m, 3)
RAY_CONFIG(double, network_sense_bw_alpha, 0.3)
RAY_CONFIG(uint32_t, network_sense_bw_concurrency_per_node, 1)
