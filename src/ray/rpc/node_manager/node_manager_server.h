...
#define RAY_NODE_MANAGER_RPC_HANDLERS                                  \
  ...
  RAY_NODE_MANAGER_RPC_SERVICE_HANDLER(NetPing)                      \
  RAY_NODE_MANAGER_RPC_SERVICE_HANDLER(NetBandwidthProbe)
...
class NodeManagerServiceHandler {
 public:
  ...
  virtual void HandleNetPing(NetPingRequest request,
                             NetPingReply *reply,
                             SendReplyCallback send_reply_callback) = 0;

  virtual void HandleNetBandwidthProbe(NetBandwidthProbeRequest request,
